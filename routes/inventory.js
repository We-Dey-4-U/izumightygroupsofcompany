...
const { auth, isAdmin, isSubAdmin, isSuperStakeholder, isIventraAdmin } = require("../middleware/auth");
...
// -------------------------------------------------
// CREATE PRODUCT (AUTO CREATE INVENTORY FOR ALL STORES) isIventraAdmin
// -------------------------------------------------
